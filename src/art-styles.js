// Art Style Definitions — 12 unique visual experiences

export const ART_STYLES = [
  { id: 'cyberpunk', name: 'Cyberpunk Neon' },
  { id: 'brutalist', name: 'Raw Brutalist' },
  { id: 'glassmorphism', name: 'Glass & Light' },
  { id: 'retro-pixel', name: 'Retro Pixel Art' },
  { id: 'editorial', name: 'Editorial Magazine' },
  { id: 'minimal-jp', name: 'Japanese Minimal' },
  { id: 'vaporwave', name: 'Vaporwave Aesthetic' },
  { id: 'organic', name: 'Organic Nature' },
